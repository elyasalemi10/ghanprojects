    ...
    >
      <div className="max-w-7xl mx-auto h-full flex items-center justify-between">
        ...
        <div className="hidden lg:block">
          <Button 
            asChild
            className="rounded-none px-6 font-heading font-bold tracking-wider text-xs bg-primary text-white hover:bg-primary/90"
          >
        ...
        {isMobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col py-6 px-6">
              {navLinks.map((link) => (
                <Link
                  ...
                  className={cn(
                    ...
                    pathname === link.path && "text-accent font-bold"
                  )}
                >
                  {link.name}
                </Link>
              ...
              <Button 
                asChild
                className="mt-6 w-full rounded-none py-6 font-heading font-bold tracking-wider bg-primary"
              >
                <Link href="/book-consultation">Contact Us</Link>
              </Button>
            </nav>
