    ...
    >
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          <Button
            onClick={calculate}
            className="flex-1 rounded-xl bg-primary hover:bg-primary/90 text-white py-6 font-heading font-bold tracking-wider transition-all shadow-lg shadow-primary/20"
          >
            Calculate
          </Button>
          <Button
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-primary rounded-xl p-6 text-white">
                <span className="text-sm text-white/70 tracking-wider">Gross Yield</span>
              ...
              <div className="bg-gradient-to-br from-accent to-accent/80 rounded-xl p-6 text-white">
                <span className="text-sm text-white/80 tracking-wider">Net Yield</span>
            ...
            {result.yearlyIncome.length > 0 && (
              <div className="bg-gray-50 rounded-xl p-6">
                <h5 className="font-bold text-primary text-sm tracking-wider mb-4">Projected Annual Income</h5>
