    ...
    >
      ...
      <div className="p-6 sm:p-8 space-y-6">
        ...
        <Button
          ...
          className="w-full rounded-none bg-accent hover:bg-accent/90 text-white py-6 font-heading font-bold tracking-wider"
        >
        ...
        {result && (
          ...
          >
            ...
            <div className="bg-secondary/30 p-6 space-y-4">
              <h5 className="font-bold text-primary text-sm tracking-wider">Key Considerations</h5>
            ...
            <div className="bg-primary/5 p-6 space-y-4">
              <h5 className="font-bold text-primary text-sm tracking-wider">Recommended Next Steps</h5>
