              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                <FadeInWhenVisible>
                  <div className="space-y-8">
                    ...
                    <div>
                      <span className="text-xs font-bold tracking-widest text-accent block mb-2">{s.subtitle}</span>
                    ...
                    <div className="flex items-center gap-4 text-primary font-bold">
                      <span className="text-xs tracking-widest border-r pr-4">Ideal For</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <FadeInWhenVisible delay={0.2}>
                    <div className="bg-background p-10 border shadow-sm h-full">
                      <h3 className="font-heading font-bold text-lg mb-8 tracking-widest text-primary border-b pb-4">The Process</h3>
                  ...
                  <FadeInWhenVisible delay={0.3}>
                    <div className="bg-primary text-white p-10 shadow-xl h-full">
                      <h3 className="font-heading font-bold text-lg mb-8 tracking-widest text-accent border-b border-white/10 pb-4">Key Benefits</h3>
                      <ul className="space-y-6">
        ...
        <div className="max-w-4xl mx-auto">
          <FadeInWhenVisible>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Button asChild size="lg" className="rounded-none px-12 py-8 text-lg font-heading font-bold tracking-wider bg-primary text-white hover:bg-primary/90">
                <Link href="/book-consultation">Contact Us</Link>
              </Button>
              <Button asChild size="lg" className="rounded-none px-12 py-8 text-lg font-heading font-bold tracking-wider bg-white text-accent hover:bg-white/90">
