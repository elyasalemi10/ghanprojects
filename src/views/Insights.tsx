          ...
          <div className="flex flex-wrap gap-3 justify-center md:justify-start">
            {categories.map(cat => (
              <button
                ...
                className={cn(
                  "px-5 py-2 rounded-none text-[10px] font-bold tracking-widest transition-all duration-300 border",
                  activeCat === cat 
      ...
      <section className="py-24 px-6 lg:px-12 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            ...
            />
            <Button type="submit" className="rounded-none bg-accent hover:bg-accent/90 text-white font-heading font-bold tracking-wider px-8 h-auto py-4">
              Subscribe
            </Button>
          </form>
        </div>
