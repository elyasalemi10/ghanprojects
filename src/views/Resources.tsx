      ...
      <section className="relative py-24 lg:py-36 px-6 lg:px-12 bg-primary text-white overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm font-bold tracking-wider text-accent">
              ...
              <div className="space-y-6">
                ...
                <form onSubmit={handleDownloadRequest} className="space-y-4">
                  ...
                  <Button 
                    ...
                    className="w-full rounded-none bg-accent hover:bg-accent/90 text-white py-6 font-heading font-bold tracking-wider h-auto"
                  >
                  ...
                  {isExternalOrTool ? (
                    ...
                    >
                      ...
                      <div className="flex-grow">
                        ...
                        <span className="text-accent font-bold tracking-wider text-xs flex items-center gap-2">
            ...
            {lockedResources.map((res, i) => (
              ...
              >
                ...
                <div className="flex-grow space-y-4">
                  ...
                  <Button 
                    variant="outline" 
                    className={`rounded-none transition-all text-xs font-bold tracking-wider px-5 h-9 gap-2 ${
                      isUnlocked 
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button asChild size="lg" className="rounded-none bg-accent hover:bg-accent/90 text-white px-8 py-6 font-heading font-bold tracking-wider">
                <Link href="/book-consultation">Contact Us</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="rounded-none bg-transparent border-white/30 text-white hover:bg-white/10 hover:text-white px-8 py-6 font-heading font-bold tracking-wider">
