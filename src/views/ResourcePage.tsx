        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            <motion.div
              ...
              className="lg:w-2/3"
            >
              <span className="text-[10px] tracking-widest font-bold text-accent mb-3 block">{resource.cat}</span>
              ...
              {resource.isExternal && resource.url && (
                <Button 
                  asChild
                  className="mt-6 rounded-none bg-accent hover:bg-accent/90 text-white py-5 px-8 font-heading font-bold tracking-wider h-auto gap-2"
                >
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-[10px] tracking-widest font-bold text-accent mb-2 block">{res.cat}</span>
                      ...
                      <span className="text-primary group-hover:text-accent font-bold tracking-widest text-[10px] flex items-center gap-2">
