    ...
    <div className="bg-background">
            ...
            {opportunities.map((opp, i) => (
              ...
              >
                ...
                <Button
                  ...
                  className="w-full rounded-none bg-accent hover:bg-accent/90 text-white py-6 font-heading font-bold tracking-wider text-xs"
                >
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap gap-4 justify-center">
          {categories.map(cat => (
            <button
              ...
              className={cn(
                "px-6 py-2 rounded-none text-xs font-bold tracking-widest transition-all duration-300 border",
                activeCat === cat 
                ...
                <div className="p-8 space-y-4">
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map(tag => (
                      <span key={tag} className="px-2 py-1 bg-accent/10 text-accent text-[10px] font-bold tracking-widest">{tag}</span>
                    ))}
                  </div>
                  ...
                  {project.value && (
                    <div className="pt-4 border-t">
                      <span className="block text-[10px] tracking-widest font-bold text-muted-foreground mb-1">Project Value</span>
                  ...
                  <div className="pt-4">
                    <Button 
                      ...
                      className="p-0 h-auto hover:bg-transparent text-primary hover:text-accent font-bold tracking-widest text-xs gap-2"
                    >
      ...
      <section className="py-32 px-6 lg:px-12 bg-primary text-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <Button asChild size="lg" className="rounded-none px-12 py-8 text-lg font-heading font-bold tracking-wider bg-accent text-white hover:bg-accent/90">
            <Link href="/book-consultation">Consult a Specialist</Link>
          </Button>
        </div>
      </section>
    </div>
