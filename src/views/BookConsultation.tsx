    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="relative py-20 lg:py-28 px-6 lg:px-12 bg-primary text-white overflow-hidden text-center">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-accent/20 border border-accent/30 rounded-full text-accent text-[10px] font-bold tracking-[0.2em] mb-6">
        ...
        <section className="py-12 lg:py-16 px-4 sm:px-6 lg:px-12 bg-secondary/30 border-b">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[10px] tracking-widest font-bold text-muted-foreground mb-1">Phone</span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[10px] tracking-widest font-bold text-muted-foreground mb-1">Email</span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[10px] tracking-widest font-bold text-muted-foreground mb-1">Office</span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <span className="block text-[10px] tracking-widest font-bold text-muted-foreground mb-1">Office Hours</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                  {isShowroomBooking ? (
                    <>
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] tracking-widest font-bold text-primary">Email or Phone</label>
                        <input 
                          name="email" 
                          type="email" 
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] tracking-widest font-bold text-primary">Preferred Visit Date</label>
                        <input 
                          name="preferredDate" 
                          type="date"
                          required
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                        <div className="space-y-2">
                          <label className="text-[10px] tracking-widest font-bold text-primary">Interest Type</label>
                        ...
                        <div className="space-y-2">
                          <label className="text-[10px] tracking-widest font-bold text-primary">Preferred Time</label>
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] tracking-widest font-bold text-primary">Message / Project Details</label>
                        <textarea
                          name="message"
                          required
                          rows={4}
                  ...
                  <Button 
                    ...
                    className="w-full rounded-none bg-primary hover:bg-primary/95 text-white py-6 sm:py-7 font-heading font-bold tracking-wider text-xs sm:text-sm h-auto flex gap-2 sm:gap-3 shadow-xl"
                  >
            ...
            <div className="lg:col-span-5 space-y-8 lg:space-y-12">
                ...
                <div className="bg-secondary/30 p-6 lg:p-10 space-y-6 lg:space-y-8 border">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                      <AccordionTrigger className="text-left font-bold text-primary text-xs sm:text-sm tracking-wider py-3 lg:py-4">Do you work with first-time investors?</AccordionTrigger>
                    ...
                    <AccordionItem value="item-2">
                      <AccordionTrigger className="text-left font-bold text-primary text-xs sm:text-sm tracking-wider py-3 lg:py-4">What areas of Melbourne do you cover?</AccordionTrigger>
                      <AccordionContent className="text-muted-foreground text-sm leading-relaxed pb-4">
                    ...
                    <AccordionItem value="item-3">
                      <AccordionTrigger className="text-left font-bold text-primary text-xs sm:text-sm tracking-wider py-3 lg:py-4">How do your fees work?</AccordionTrigger>
                      <AccordionContent className="text-muted-foreground text-sm leading-relaxed pb-4">
                    ...
                    <AccordionItem value="item-4">
                      <AccordionTrigger className="text-left font-bold text-primary text-xs sm:text-sm tracking-wider py-3 lg:py-4">Do you guarantee investment returns?</AccordionTrigger>
                      <AccordionContent className="text-muted-foreground text-sm leading-relaxed pb-4">
              ...
              <div className="p-6 lg:p-8 border border-accent/20 bg-accent/5 rounded-sm space-y-3 lg:space-y-4">
                <div className="flex items-center gap-3 text-accent font-bold tracking-widest text-[10px]">
        ...
        <section className="h-[400px] w-full bg-secondary grayscale">
          <div className="w-full h-full flex items-center justify-center bg-secondary/50 border-y">
            <div className="text-center space-y-4">
              ...
              <span className="text-xs tracking-[0.3em] font-bold text-muted-foreground/60">7 Hammel Court, Hallam 3803, Victoria</span>
            </div>
          </div>
        </section>
      )}
